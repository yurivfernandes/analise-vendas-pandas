...
class AnaliseMensalEquipeVendasView(APIView, DataFrameGenerics):
    ...
    fields = {
        'origem': openapi.Schema(
            type=openapi.TYPE_STRING,
            example=3,
            description="Identificação do módulo do sistema VP6 de onde originou-se o dado",
            enum=["PESSOAL", "OPEX", "INTEGRAÇÃO"]),
        'rubrica': openapi.Schema(
            type=openapi.TYPE_STRING,
            example="MARKETING",
            description="Classificação do evento de acordo com as regras do sistema VP6"),
        'empresa': openapi.Schema(
            type=openapi.TYPE_STRING,
            example="GRUPO VP6",
            description="Nome da empresa no cadastro VP6"),
        'local': openapi.Schema(
            type=openapi.TYPE_STRING,
            example="VP6 EMPREENDIMENTO",
            description="Local de apropriação do evento de acordo com o cadastro VP6. Centro de custo, módulo etc"),
        'tipo': openapi.Schema(
            type=openapi.TYPE_STRING,
            example="PLANEJADO",
        ...
        'data': openapi.Schema(
            type=openapi.TYPE_STRING,
            example="2021-12-01",
            description="Data do evento. Sempre dia: '01'",
            format=openapi.FORMAT_DATE),
        'valor': openapi.Schema(
